...
Provides:       %{name}-macros = 2.0
Obsoletes:      %{name}-macros < 2.0
...
%package mysql
Provides:       %{name}-mysql
Provides:       %{name}-mysqli = %{version}
Provides:       %{name}-pdo_mysql = %{version}
Provides:       php_any_db
Summary:        PHP5 Extension Module
Group:          Development/Libraries/PHP
Requires:       %{name} = %{version}
...
Obsoletes:      %{name}-pdo_mysql < %{version}
...
%if %{with_firebird}
%package firebird
Provides:       %{name}-interbase
Provides:       %{name}-pdo_firebird = %{version}
Provides:       php_any_db
Summary:        PHP5 Extension Module
Group:          Development/Libraries/PHP
Requires:       %{name} = %{version}
Requires:       %{name}-pdo = %{version}
Obsoletes:      %{name}-pdo_firebird < %{version}
...
%package pgsql
Provides:       %{name}-pgsql
Provides:       %{name}-pdo_pgsql = %{version}
Provides:       php_any_db
Summary:        PHP5 Extension Module
Group:          Development/Libraries/PHP
Requires:       %{name} = %{version}
Requires:       %{name}-pdo = %{version}
Obsoletes:      %{name}-pdo_pgsql < %{version}
