#
# spec file for package php53v-mailparse
#
...
-  changed package name from php53m-mailparse to php53v-mailparse

* Mon Jan 30 2017 Marcin Morawski <marcin@morawskim.pl>
-  init release
